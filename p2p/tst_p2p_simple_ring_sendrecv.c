...
int tst_p2p_simple_ring_sendrecv_init (struct tst_env * env)
{
  int comm_rank;
  MPI_Comm comm;
...
int tst_p2p_simple_ring_sendrecv_run (struct tst_env * env)
{
  int comm_size;
  int comm_rank;
  int send_to;
...
int tst_p2p_simple_ring_sendrecv_cleanup (struct tst_env * env)
{
