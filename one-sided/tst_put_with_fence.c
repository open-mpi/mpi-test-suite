...
int tst_put_with_fence_alltoall_init (struct tst_env * env)
{
  MPI_Comm comm;
  int comm_rank;
  int comm_size;
...
int tst_put_with_fence_alltoall_run (struct tst_env * env)
{
  int i,j;
  int comm_size;
  int type_size;
...
int tst_put_with_fence_alltoall_cleanup (struct tst_env * env)
{
  MPI_Comm comm;
  int i;
  int comm_size;
