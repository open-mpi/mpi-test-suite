...
int tst_accumulate_with_lock_max_init (struct tst_env * env)
{
  MPI_Comm comm;
  int comm_rank;
  int comm_size;
...
int tst_accumulate_with_lock_max_run (struct tst_env * env)
{
  int i;
  int comm_size;
  int type_size;
...
int tst_accumulate_with_lock_max_cleanup (struct tst_env * env)
{
